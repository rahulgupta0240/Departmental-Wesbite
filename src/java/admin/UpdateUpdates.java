...
public class UpdateUpdates extends HttpServlet {
    private final String UPLOAD_DIRECTORY = "C:\\Users\\admin\\Downloads\\education\\WebApplication1\\web\\img\\updates\\";
...
check=true;
   ...
   if(check)
   {
    Database ob = null; 
        try {
            ob = new Database();
            ob.updateUpdates(id,title, des, name);
