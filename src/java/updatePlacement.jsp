...
<%
  if(session.getAttribute("user")!= null)
  {
   ...
   ResultSet resultSet=database.updatePlacement(id);
				...
				<div class="container">
					<div class="row justify-content-between align-items-center">
						<div class="col-lg-6 col-md-6 search-course-left">
							<h1 class="text-white">
								Edit Your Placement Details here <span class="lnr lnr-pointer-right"></span>
							</h1>
							<p>
								</p>
						...
						<div class="col-lg-4 col-md-6 search-course-right section-gap">
                                                    ...
                                                    <form class="form-wrap" action="UpdatePlacement" method="post" enctype="multipart/form-data">
								<h4 class="text-white pb-20 text-center mb-30">Correct Your Mistake Here </h4>		
                                                             <input type="hidden" class="form-control" name="id" value=" <%= resultSet.getInt(1)%> " required/>
                                                     
                                                                <input type="text" class="form-control" name="name" value="<%= resultSet.getString(2)%>" required >
                                                                <input type="text" class="form-control" name="cname"value="<%= resultSet.getString(3)%>" required>
                                                                <input type="text" class="form-control" name="salary" value="<%= resultSet.getString(4)%>" required>
                                                                <input type="file" name="file" required>
															
                                                                <input type="submit" class="primary-btn text-uppercase" value="Update">
							</form>
                                                                <% } %>
						</div>
					</div>
