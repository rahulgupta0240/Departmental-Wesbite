				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="index.jsp">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="viewGallery.jsp"> Gallery</a></p>
						</div>	
					</div>
				</div>
			</section>
			...
			<section class="gallery-area section-gap">
				<div class="container">
					<div class="row">
                         ...
                         ResultSet resultSet=database.getGallery();
        ...
        while (resultSet.next()) {      
            %>
						...
						<div class="col-lg-4 pop">
                                                <!--    <a href="img/gallery/***********" class="img-gal" >
								      
                                                                        <div class="single-imgs relative">		
									<div class="overlay overlay-bg"></div>
									<div class="relative">				
                                                                            <img class="img-fluid " src="img/gallery/**************" alt="">		
									...
									<div class="overlay overlay-bg"></div>
									<div class="relative">				
                                                                            <img class="img-fluid img" src="img/gallery/<%= resultSet.getString(2)%>" alt="" >		
                                                                                  
                                                                        </div>
                                                                             <div class="Bpop">
                                                                                <a href="uploadGallery.jsp?id=<%= resultSet.getString(1)%>" class="text-uppercase primary-btn mx-auto mt-40">Update</a>		
					                                <a href="DeleteGallery?id=<%= resultSet.getInt(1)%>" class="text-uppercase primary-btn mx-auto mt-40">Delete</a>		
                                                                                </div>
								</div>
