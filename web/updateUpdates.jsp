...
<%
  if(session.getAttribute("user")!= null)
  {
   ...
   ResultSet resultSet=database.updateUpdates(id);
					...
					<div class="row justify-content-between align-items-center">
						<div class="col-lg-6 col-md-6 search-course-left">
							<h1 class="text-white">
								Did Something Wrong ?
                                                                <br>
                                                                Edit Here <span class="lnr lnr-pointer-right"></span>
							</h1>
							<p></p>
						...
						<div class="col-lg-4 col-md-6 search-course-right section-gap">
                                                    <form class="form-wrap" action="UpdateUpdates" method="post" enctype="multipart/form-data">
								<h4 class="text-white pb-20 text-center mb-30">Correct Your Mistakes Here</h4>		
