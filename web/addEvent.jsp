				...
				<div class="container">
					<div class="row justify-content-between align-items-center">
						<div class="col-lg-6 col-md-6 search-course-left">
							<h1 class="text-white">
								Update the Latest Event and Workshop Here    <span class="lnr lnr-pointer-right"></span>
							</h1>
							<p>
							</p>
						...
						<div class="col-lg-4 col-md-6 search-course-right section-gap">
                                                    <form class="form-wrap" action="AddEvent" method="post" enctype="multipart/form-data">
								<br><h4 class="text-white pb-20 text-center mb-30">Update Latest Events and Workshop</h4>		
                                                                <input type="text" class="form-control" name="title" placeholder="Enter Event Name" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Event Name'" required>
