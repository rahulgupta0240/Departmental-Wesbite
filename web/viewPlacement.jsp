				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="index.jsp">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="viewPlacement.jsp"> Placements</a></p>
						</div>	
					</div>
				</div>
			</section>
							...
							<div class="single-carusel row align-items-center pop">
								<div class="col-12 col-md-6 thumb">
									<img class="img-fluid img img-eve" src="img/placement/<%= resultSet.getString(5)%>" alt="">
                                                                        ...
                                                                        <a href="updatePlacement.jsp?id=<%= resultSet.getString(1)%>" class="text-uppercase primary-btn mx-auto mt-40">Update</a>		
					                                <a href="DeletePlacement?id=<%= resultSet.getInt(1)%>" class="text-uppercase primary-btn mx-auto mt-40">Delete</a>		
					                              </h4>
								</div>
