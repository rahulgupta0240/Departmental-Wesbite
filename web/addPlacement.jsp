				...
				<div class="container">
					<div class="row justify-content-between align-items-center">
						<div class="col-lg-6 col-md-6 search-course-left">
							<h1 class="text-white">
								Add Latest Placement
                                                                <br>
                                                                
                                                                Here &nbsp;&nbsp;&nbsp;<span class="lnr lnr-pointer-right"></span>
							</h1>
							<p></p>
						...
						<div class="col-lg-4 col-md-6 search-course-right section-gap">
                                                    <form class="form-wrap" action="AddPlacement" method="post" enctype="multipart/form-data">
								<br><br><h4 class="text-white pb-20 text-center mb-30">Add Latest Placement Details Here</h4>		
                                                                <input type="text" class="form-control" name="name" placeholder="Enter Student Name" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Student Name'"  required>
                                                                <input type="text" class="form-control" name="cname" placeholder="Enter Company Name" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Company Name'" required>
                                                                <input type="text" class="form-control" name="salary" placeholder="Enter Package(in Lac) " onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Package(in Lac)'" required>
