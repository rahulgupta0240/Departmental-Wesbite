...
<%
  if(session.getAttribute("user")!= null)
  {
   ...
   ResultSet resultSet=database.updateStaff(id);
				...
				<div class="container">
					<div class="row justify-content-between align-items-center">
						<div class="col-lg-6 col-md-6 search-course-left">
							<h1 class="text-white">
								Update the Mistake You did <span class="lnr lnr-pointer-right"></span></h1>
							<p></p>
						...
						<div class="col-lg-4 col-md-6 search-course-right section-gap">
                                                                       ...
                                                                       <%  while (resultSet.next()) {      
                                                                                                %>
                                                    <form class="form-wrap" action="UpdateStaff" method="post" enctype="multipart/form-data">
                           ...
                           <input type="text" class="form-control" name="name" value="<%= resultSet.getString(2)%>" required>
                                                                <input type="text" class="form-control" name="qualification" value="<%= resultSet.getString(3)%>" required>
