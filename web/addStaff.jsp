				...
				<div class="container">
					<div class="row justify-content-between align-items-center">
						<div class="col-lg-6 col-md-6 search-course-left">
							<h1 class="text-white">
								Add New Faculty From Here  <span class="lnr lnr-pointer-right"></span>
						...
						<div class="col-lg-4 col-md-6 search-course-right section-gap">
                                                    <form class="form-wrap" action="AddStaff" method="post" enctype="multipart/form-data">
								<br><br>
                                                                <h4 class="text-white pb-20 text-center mb-30">Enter New Faculty Details Here</h4>		
								<input type="text" class="form-control" name="name" placeholder="Enter Faculty Name" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Faculty Name'" required>
                                                                <input type="text" class="form-control" name="qualification" placeholder="Enter Qualification" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Qualification'" required>
