				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="index1.jsp">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="gallery.jsp"> Gallery</a></p>
						</div>	
					</div>
				</div>
			</section>
        ...
        while (resultSet.next()) {      
            %>
						...
						<div class="col-lg-4 pop">
                                                   <a href="img/gallery/<%= resultSet.getString(2)%>" class="img-gal" >
