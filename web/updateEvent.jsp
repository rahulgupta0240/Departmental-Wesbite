...
<%
  if(session.getAttribute("user")!= null)
  {
   ...
   ResultSet resultSet=database.updateEvent(id);
				...
				<div class="container">
					<div class="row justify-content-between align-items-center">
						<div class="col-lg-6 col-md-6 search-course-left">
							<h1 class="text-white">
								Update Your Event <span class="lnr lnr-pointer-right"></span>
							</h1>
							<p></p>
						...
						<div class="col-lg-4 col-md-6 search-course-right section-gap">
                                                    ...
                                                    <form class="form-wrap" action="UpdateEvent" method="post" enctype="multipart/form-data">
								<h4 class="text-white pb-20 text-center mb-30">Correct Your Mistake Here</h4>		
                                                                ...
                                                                <input type="text" class="form-control" name="title" value="<%= resultSet.getString(2)%>" required>
                                                                <textarea  class="form-control" name="description" required > <%= resultSet.getString(3)%> </textarea>
                                                                <input type="date" class="form-control" name="date" value="<%= resultSet.getString(4)%>" required >
