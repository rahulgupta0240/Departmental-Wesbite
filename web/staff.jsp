<%-- 
    Document   : viewStaff
    Created on : 14 Nov, 2018, 11:01:05 PM
    Author     : admin
--%>
				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="index1.jsp">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="staff.jsp"> Staff Details</a></p>
						</div>	
					</div>
				</div>
			</section>
					...
					<div class="row d-flex justify-content-center">
						<div class="menu-content pb-70 col-lg-8">
							<div class="title text-center">
								<h1 class="mb-10">Our Faculty Members</h1>
							</div>
						</div>
					</div>						
					<div class="row">
                         ...
                         ResultSet resultSet=database.getStaff();
       ResultSetMetaData resultSetMeta=resultSet.getMetaData();
        while (resultSet.next()) {      
            %>
            <div class="single-popular-carusel col-lg-3 col-md-6 pop">
							<div class="thumb-wrap relative">
								<div class="thumb relative">
									<div class="overlay overlay-bg"></div>	
									<img class="img-fluid img img-eve" src="img/staff/<%= resultSet.getString(4)%>" alt="">
